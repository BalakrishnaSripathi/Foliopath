...
export default function CombinedDashboard() {  const { role } = useAuth();
  ...
  // ==================== STUDENT ACTIONS ====================
  // (status toggle + details live inside AllStudentsTable)
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Student management — super admin + staff */}
        <AllStudentsTable
          isSuperAdmin={isSuperAdmin}
          onResetPassword={(student) =>
            setResetModal({ type: "student", user: student })
          }
        />
        ...
        {/* Contact Us submissions: who filled the contact form */}
        <ContactUsTable />
      </div>
